...
func cgen_wb(n, res *Node, wb bool) {
	...
	case OMINUS:
		...
		if Ctxt.Arch.Family == sys.ARM {
			...
			Thearch.Gins(a, &n2, &n1)
		} else if Ctxt.Arch.Family == sys.ARM64 || Ctxt.Arch.Family == sys.SPARC64 {
...
abop: // asymmetric binary
	...
	if nl.Ullman >= nr.Ullman {
		...
		if Smallintconst(nr) && Ctxt.Arch.Family != sys.MIPS64 && Ctxt.Arch.Family != sys.ARM && Ctxt.Arch.Family != sys.ARM64 && Ctxt.Arch.Family != sys.PPC64 && Ctxt.Arch.Family != sys.SPARC64 { // TODO(rsc): Check opcode for arm
			n2 = *nr
		} else {
